        ...
        <TooltipProvider>
            <Tooltip>
                <TooltipTrigger asChild>
                    <Button id="info" size={"icon"} className="hidden lg:flex fixed z-99 bottom-[100px] xl:bottom-[20px] right-[40px] shadow-lg rounded-xl">
                ...
                <TooltipContent>
                    <p>Using Chrome? This website takes advantage of the 
                        <a className='ml-1 text-cyan-800 underline' href='https://developer.chrome.com/docs/web-platform/view-transitions/'>
